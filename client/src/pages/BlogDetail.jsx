...
const BlogDetail = () => {
    ...
    const FilterCol = ()=>{
        const RecentBox = () =>{
            return(
                <div className="flex gap-2 items-center">
                    ...
                    <div className=" p-3">
                        <h1 className=' line-clamp-2 !font-heading text-lg font-semibold text-heading capitalize'>study tips fo college saec</h1>
                    </div>
                </div>
            )
        }
        ...
        const CategoryBox =()=>{
            return(
                <div className="flex">
                        <h2 type="text" placeholder='search latest news' className='w-full capitalize p-4 bg-white text-paragraph' >Course Curriculum</h2>
                        <button className=' bg-primary text-white p-3 text-lg'>(3)</button>
                    </div>
            )
        }
        return(
            <div className="xl:w-[35%] space-y-8">
                ...
                <section>
                    <div className="flex flex-col gap-6 bg-foreground p-8 ">
                        <h1 className=' !font-heading text-2xl capitalize font-medium text-heading'>recent post</h1>
                ...
                <section>
                    <div className="flex flex-col gap-6 bg-foreground p-8 ">
                        <h1 className=' !font-heading text-2xl capitalize font-medium text-heading'>Category</h1>
                        <div className="flex flex-col gap-3">
